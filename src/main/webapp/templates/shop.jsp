...
<!-- Mirrored from template.hasthemes.com/hurst-v1/hurst/shop.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 11:08:30 GMT -->
<head>
		<meta charset="utf-8">
							...
							<li><a href="home">home</a>
								<div class="sub-menu menu-scroll">
									<ul>
										...
										<li><a href="home">Home Version 1</a></li>
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6">
                                <div class="single-footer">
                                    ...
                                    <ul class="footer-menu">
                                        ...
                                        <li><a href="login.jsp"><i class="zmdi zmdi-dot-circle"></i>Sign In</a></li>
