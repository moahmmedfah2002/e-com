...
<!-- Mirrored from template.hasthemes.com/hurst-v1/hurst/login.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 11:08:45 GMT -->
<head>
		<meta charset="utf-8">
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="customer-login text-left">
									...
									<p class="text-gray">If you have an account with us, Please login!</p>
									<input type="hidden" name="type" value="logup" >
									<form action="" method="post">
										<input type="hidden" name="type" value="logup">
										<input type="text" placeholder="Nom address here..." name="nom" required>
										<input type="text" placeholder="Prenom address here..." name="prenom" required>
										<input type="text" placeholder="Email address here..." name="email" required>
										<input type="password" placeholder="Password" name="pass" required>
										<input type="password" placeholder="Confirm password" name="pass-confirm" required>
										<p class="mb-0">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-6">
                                <div class="single-footer">
                                    ...
                                    <ul class="footer-menu">
                                        <li><a href="profile.jsp"><i class="zmdi zmdi-dot-circle"></i>My Account</a></li>
