...
<!-- Mirrored from template.hasthemes.com/hurst-v1/hurst/home.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 11:08:24 GMT -->
<head>
		<meta charset="utf-8">
...
<%--	<c:import url="data.xml" var="produit"/>--%>
<%--	<x:parse xml="${produit}" var="prod" />--%>
<%--	<x:forEach select="$prod/products/product" var="obj" >--%>
<%--		<h1><x:out select="$obj/nom"></x:out> </h1>--%>
...
<%--																<sql:query var="produit"  dataSource="jdbc/myDatabase">--%>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="section-title text-center">
								<h2 class="title-border">Nos Produit</h2>
							</div>
						</div>
					</div>
					<div class="row">
								...
								<div class="tab-pane" id="most-view">
									<div class="row">
										...
										<div class="single-product col-xl-3 col-lg-4 col-md-6">
											...
											<div class="product-info clearfix">
												<div class="fix">
													<h4 class="post-title floatleft"><a href="#">Nos Produit</a></h4>
													<p class="floatright hidden-sm">Furniture</p>
												</div>
												<div class="fix">
													<span class="pro-price floatleft">$ 36.20</span>
...
<!-- Mirrored from template.hasthemes.com/hurst-v1/hurst/home.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 11:08:30 GMT -->
</html>
